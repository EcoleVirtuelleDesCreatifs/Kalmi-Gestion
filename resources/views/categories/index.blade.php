...
<head>
    ...
    <title>Catégories - Kalmi Gestion</title>
    ...
    <div class="flex flex-col lg:flex-row min-h-screen">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <header class="lg:hidden bg-white shadow-sm px-4 py-3">
                <div class="flex items-center justify-between">
                    <h2 class="text-lg font-bold text-gray-800">Catégories</h2>
                    <a href="{{ route('profile.edit') }}" class="text-gray-600 hover:text-gray-900">
            ...
            <main class="p-3 sm:p-4 lg:p-6">
                <div class="mb-4 sm:mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h2 class="text-xl lg:text-2xl font-bold text-gray-800">Catégories</h2>
                        <p class="text-sm text-gray-600 mt-1">Gestion des catégories de produits</p>
                    </div>
                    <a href="{{ route('categories.create') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition text-sm sm:text-base">
