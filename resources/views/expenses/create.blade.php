...
<head>
    ...
    <title>Nouvelle Dépense - Kalmi Gestion</title>
            ...
            <main class="p-3 sm:p-4 lg:p-6">
                ...
                <div class="max-w-2xl mx-auto">
                    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                        <div class="p-6">
                            <div class="mb-6">
                                <h2 class="text-2xl font-bold text-gray-800 mb-2">Ajouter une dépense</h2>
                                <p class="text-gray-600">Enregistrez une nouvelle dépense ou frais opérationnel</p>
                            </div>
                            ...
                            <form method="POST" action="{{ route('expenses.store') }}" class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text"
                                           ...
                                           placeholder="Ex: Transport marchandise, Achat fournitures, etc.">
                                </div>
                                ...
                                <div>
                                    ...
                                    <textarea id="notes"
                                              ...
                                              rows="4"
                                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                                              placeholder="Informations supplémentaires sur cette dépense...">{{ old('notes') }}</textarea>
                                </div>
